...
```
openlibrary <command> [arguments] [flags]
```

Run `openlibrary <command> --help` for the full flag list on any command. This
...
per operation you declare in `openlibrary/domain.go`.
