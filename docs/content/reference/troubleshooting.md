...
Most of these come down to network reality or how openlibrary serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

openlibrary rate-limits like any public site. openlibrary already paces
...
Where a surface is gated, openlibrary reads a cookie or token you supply
...
`openlibrary`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what openlibrary actually did
