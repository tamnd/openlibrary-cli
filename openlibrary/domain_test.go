...
// HTTP behaviour is covered in openlibrary_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "openlibrary://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("openlibrary", "about")
	if err != nil || got.String() != "openlibrary://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want openlibrary://page/about", got.String(), err)
	}
}
